    ...
    actions: {
        async list({ commit, rootGetters }, payload: DatatableParams) {
            ...
            const result = await getJson(
                'administrator/configuration/users/list', {
        ...
        async create({ commit, rootGetters }, payload) {
            ...
            const result = await postJson(
                'administrator/configuration/users/create', 
                payload
            );
        ...
        async view({ commit, rootGetters }, payload: number) {
            ...
            const result = await getJson<{ user: any }>(
                `administrator/configuration/users/${payload}/view`
            );
            ...
            commit('SET_VIEW', result.data.user)
        ...
        async edit({ commit, rootGetters }, payload) {
            ...
            const result = await putJson(
                `administrator/configuration/users/${payload.id}/edit`, 
                payload.body
            );
