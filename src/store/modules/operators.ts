...
export const operators: Module<OperatorsState, any> = {
    namespaced: true,
    state: () => ({
        prospects: null,
        table: {
    ...
    actions: {
        ...
        async create({ commit, rootGetters }, payload) {
            ...
            const result = await postJson(
                'administrator/operators/create', 
                payload
            );
        ...
        async view({ commit, rootGetters }, payload: number) {
            ...
            const result = await getJson(
                `administrator/operators/${payload}/view`
            );
        ...
        async edit({ commit, rootGetters }, payload) {
            ...
            const result = await putJson(
                `administrator/operators/${payload.id}/edit`, 
                payload.body
            );
